...
export PATH="$HOME/eclipse/java-2018-12:$PATH"
...
alias texcompile='~/tool/./tex.sh'

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/munvei/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/munvei/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/munvei/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/munvei/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
